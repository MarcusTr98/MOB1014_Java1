...
public class Bai4 {
    public static void giaiPTBac1() {
        ...
        System.out.println("Moi nhap vao he so a: ");double a=sc.nextDouble();
        System.out.println("Moi nhap vao he so b: ");double b=sc.nextDouble();
    ...
    public static void giaiPTBac2() {
        ...
        System.out.println("Moi nhap vao he so a: ");double a= sc.nextDouble();
        System.out.println("Moi nhap vao he so b: ");double b= sc.nextDouble();
        System.out.println("Moi nhap vao he so c: ");double c= sc.nextDouble();
